...
class FTPClient {
    ...
    public static void main(String argv[]) throws Exception {
        ...
        // When the command connect is entered it will attempt a connection to the
        // server and then allow for more commands
        if (sentence.startsWith("connect")) {
            ...
            while (isOpen && clientgo) {
                 ...
                 * files in the current directory on which it is executing. The client should
                 * get the list and display it on the screen.
                 */
                 ...
                 * the connection. When the ftp_server receives the quit command it should close
